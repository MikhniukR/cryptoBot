...
public class SubAccountUpdateRequest {
  ...
  public AccountUpdateModeEnum getAccountUpdateMode() {
    return accountUpdateMode;
  }

  public void setAccountUpdateMode(AccountUpdateModeEnum accountUpdateMode) {
    this.accountUpdateMode = accountUpdateMode;
  }
}
